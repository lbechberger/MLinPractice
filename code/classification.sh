...
python -m code.classification.run_classifier data/feature_extraction/training.pickle -e data/classification/classifier.pickle --randforest 50 --forest_max_depth 10 --forest_criterion "entropy" -s 42 -a -k -f1 -ba
