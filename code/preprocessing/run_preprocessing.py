...
from code.util import COLUMN_TWEET, SUFFIX_STOPWORDS_REMOVED, SUFFIX_TOKENIZED
...
parser.add_argument("--stopwords_remover_input", help = "input column to stopword_remover", default = COLUMN_TWEET)
