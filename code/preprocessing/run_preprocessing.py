...
from code.util import COLUMN_TWEET, SUFFIX_TOKENIZED, SUFFIX_PUNCT_REMOVED
...
parser.add_argument("--punctuation_input", help = "input column from which to remove punctuation", default = COLUMN_TWEET)
...
preprocessors = []
if args.punctuation:
    preprocessors.append(PunctuationRemover(args.punctuation_input, args.punctuation_input + SUFFIX_PUNCT_REMOVED))
if args.tokenize:
