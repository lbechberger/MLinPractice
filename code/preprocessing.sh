...
python -m code.preprocessing.run_preprocessing data/preprocessing/labeled.csv data/preprocessing/preprocessed.csv --pipeline tweet punctuation lowercase tokenize standardize numbers -e data/preprocessing/pipeline.pickle
