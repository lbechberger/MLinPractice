...
python -m code.preprocessing.run_preprocessing data/preprocessing/labeled.csv data/preprocessing/preprocessed.csv -p -t --tokenize_input 'tweet_punctuation_removed' -s --stopwords_input 'tweet_punctuation_removed_tokenized' -e data/preprocessing/pipeline.pickle
