...
python -m code.preprocessing.run_preprocessing data/preprocessing/labeled.csv data/preprocessing/preprocessed.csv --pipeline tweet replace_urls punctuation lowercase expand tokenize numbers standardize lemmatize remove_stopwords -e data/preprocessing/pipeline.pickle --fast
