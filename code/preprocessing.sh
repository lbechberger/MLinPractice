...
python -m code.preprocessing.run_preprocessing data/preprocessing/labeled.csv data/preprocessing/preprocessed.csv --pipeline tweet remove_urls lowercase expand punctuation standardize tokenize numbers lemmatize remove_stopwords -e data/preprocessing/pipeline.pickle
