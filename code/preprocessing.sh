...
python -m code.preprocessing.run_preprocessing data/preprocessing/labeled.csv data/preprocessing/preprocessed.csv --pipeline tweet punctuation lowercase expand tokenize replace_urls numbers standardize lemmatize remove_stopwords -e data/preprocessing/pipeline.pickle
