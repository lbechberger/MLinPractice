...
python -m code.preprocessing.run_preprocessing data/preprocessing/labeled.csv data/preprocessing/preprocessed.csv --tokenize --punctuation_removing --stopwords_removing --lemmatize -e data/preprocessing/pipeline.pickle
