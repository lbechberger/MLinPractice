...
class PunctuationRemoverTest(unittest.TestCase):
    ...
    def test_input_columns(self):
        self.assertListEqual(self.punctuation_remover._input_columns, [
                             self.INPUT_COLUMN])

    def test_output_column(self):
        self.assertEqual(
            self.punctuation_remover._output_column, self.OUTPUT_COLUMN)
    ...
    def test_punctuation_remover(self):
        ...
        self.assertListEqual(
            punctuationremoved[self.OUTPUT_COLUMN][0], output_text_tokenized)
