...
class StopwordsRemoverTest(unittest.TestCase):
    ...
    def test_input_columns(self):
        self.assertListEqual(self.stopwordsremover._input_columns, [
                             self.INPUT_COLUMN])

    def test_output_column(self):
        self.assertEqual(self.stopwordsremover._output_column,
                         self.OUTPUT_COLUMN)
    ...
    def test_removing_english_stopwords(self):
        ...
        self.assertListEqual(
            stopwordsremoved[self.OUTPUT_COLUMN][0], output_text_tokenized)
