...
class ImageCounterTest(unittest.TestCase):

    def setUp(self):
        self.INPUT_COLUMN = "photos"
        self.images = ImagesCounter(self.INPUT_COLUMN)
        self.df = pd.DataFrame()
        self.df[self.INPUT_COLUMN] = [
            "['https://pbs.twimg.com/media/D5afNaGX4AA3gC9.jpg', 'https://pbs.twimg.com/media/D5afNaKXkAAZbpo.jpg', 'https://pbs.twimg.com/media/D5afNaKWsAIab9W.jpg']"]
