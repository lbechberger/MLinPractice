...
class KeywordTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.number_of_keywords = 3
        self.inputs = [["test", "test"], ["doof","test"], ["ml","doof"], ["Not viral","ml"]]
        self.labels = [True,True,True,False]
        ...
        self.keyword._set_variables([self.inputs, self.labels])
    ...
    def test_keywords_get_values(self):
        function_output = self.keyword._get_values(self.inputs)
        test_value = [self.expected_outputs == function_output]
        self.assertTrue(test_value)

    def test_input_columns(self):
        self.assertEqual(self.keyword._input_columns, [self.INPUT_COLUMN, self.LABEL_COLUMN])

    def test_feature_name(self):
        self.assertEqual(self.keyword.get_feature_name(), "keywords")
