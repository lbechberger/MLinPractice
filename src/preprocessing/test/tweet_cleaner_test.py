...
class TweetCleanerTest(unittest.TestCase):
    ...
    def test_punctuation_removal(self):
        input_sentence = "This is an example sentence. SENTENCE!! And another sentence . And more"
        expected_output_text = "This is an example sentence SENTENCE And another sentence And more"
    ...
    def test_url_removal2(self):
        ...
        expected_output_text = "Big Data needs data science but data science doesnt need big data"
    ...
    def test_cleaning(self):
        ...
        expected_output_text = "is greater than the sum of its parts RT"
