...
from codes.util import COLUMN_TWEET, COLUMN_LABEL, COLUMN_PREPROCESS, COLUMN_PHOTOS
...
parser.add_argument("--photo_bool", action= "store_true", help= "XXXXXXXXXXXXXXXXXXXXXXXXXX")
